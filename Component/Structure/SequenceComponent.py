...
class SequenceComponent(StructureComponent.StructureComponent[SequenceStructure.SequenceStructure]):
    ...
    type_verifier = TypeVerifier.TypedDictTypeVerifier(
        TypeVerifier.TypedDictKeyTypeVerifier("addition_cost", False, (float, int)),
        ...
        TypeVerifier.TypedDictKeyTypeVerifier("deletion_cost", False, (float, int)),
        ...
        TypeVerifier.TypedDictKeyTypeVerifier("substitution_cost", False, (float, int)),
    ...
    def initialize_fields(self, data: ComponentTyping.SequenceTypedDict) -> Sequence[Field.Field]:
