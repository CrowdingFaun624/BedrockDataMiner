...
class StructureField(ComponentGroupField.ComponentGroupField["BaseComponent.BaseComponent"]):
    ...
    def set_field(
        ...
        self.subcomponent, is_inline = Field.choose_component(None, source_component, STRUCTURE_BASE_PATTERN, self.component_group, {}, self.error_path, create_component_function, None)
