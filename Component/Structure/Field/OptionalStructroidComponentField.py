...
STRUCTROID_COMPONENT_PATTERN:Pattern.Pattern[Union["StructureComponent.StructureComponent", "AbstractGroupComponent.AbstractGroupComponent"]] = Pattern.Pattern([{"is_group": True}, {"is_structure": True}])
...
class OptionalStructroidComponentField(OptionalComponentField.OptionalComponentField[Union["StructureComponent.StructureComponent", "AbstractGroupComponent.AbstractGroupComponent"]]):
    ...
    def __init__(self, subcomponent_data:str|ComponentTyping.StructroidComponentTypedDicts|None, path: list[str|int], pattern:Pattern.Pattern=STRUCTROID_COMPONENT_PATTERN, *, allow_inline:Field.InLinePermissions=Field.InLinePermissions.mixed) -> None:
        '''
