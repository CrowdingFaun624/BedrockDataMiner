...
class OptionalStructroidComponentField(OptionalComponentField.OptionalComponentField[Union["StructureComponent.StructureComponent", "AbstractGroupComponent.AbstractGroupComponent"]]):
    ...
    def __init__(self, subcomponent_data:str|ComponentTyping.StructroidTypedDicts|None, path: list[str|int], pattern:Pattern.Pattern=STRUCTROID_COMPONENT_PATTERN, *, allow_inline:Field.InlinePermissions=Field.InlinePermissions.mixed) -> None:
        '''
