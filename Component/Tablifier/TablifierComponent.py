...
class TablifierComponent(Component[Tablifier]):
    ...
    def initialize_fields(self, data: TablifierTypedDict) -> Sequence[Field]:
        ...
        self.dataminer_collection_field = ComponentField(data["dataminer_collection"], ABSTRACT_DATAMINER_COLLECTION_PATTERN, ("dataminer_collection",), allow_inline=InlinePermissions.reference, assume_component_group="dataminer_collections")
