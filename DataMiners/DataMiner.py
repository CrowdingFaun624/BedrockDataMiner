...
class DataMinerCollection():
    ...
    def compare(self, version1:Version.Version|None, version2:Version.Version, versions_between:list[Version.Version], all_dataminers:list["DataMinerCollection"], store:bool=True) -> str:
        ...
        if version1 is None:
            ...
            version2_data = self.comparer.normalize(self.get_data_file(version2), version2, dataminers_dict)
        data_comparison = Compare.compare(version1_data, version2_data)
