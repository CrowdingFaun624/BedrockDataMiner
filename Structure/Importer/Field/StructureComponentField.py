...
class StructureComponentField(ComponentField.ComponentField["StructureComponent.StructureComponent"]):
    ...
    def __init__(self, subcomponent_str:str, path: list[str|int], capabilities_pattern:ComponentCapabilities.CapabilitiesPattern=STRUCTURE_COMPONENT_REQUEST_PROPERTIES) -> None:
        '''
