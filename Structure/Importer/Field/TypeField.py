...
class TypeField(AbstractTypeField.AbstractTypeField):
    ...
    def set_field(
        ...
        if self.subcomponent_data in StructureComponent.DEFAULT_TYPES:
            ...
            component, is_in_line = Field.choose_component(self.subcomponent_data, source_component, TYPE_ALIAS_REQUEST_PROPERTIES, components, imported_components, self.error_path, create_component_function)
            if is_in_line:
