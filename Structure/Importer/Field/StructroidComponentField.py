...
class StructroidComponentField(ComponentField.ComponentField[Union["StructureComponent.StructureComponent", "AbstractGroupComponent.AbstractGroupComponent"]]):
    ...
    def __init__(self, subcomponent_str:str, path: list[str|int], capabilities_pattern:ComponentCapabilities.CapabilitiesPattern=STRUCTUROID_COMPONENT_REQUEST_PROPERTIES) -> None:
        '''
