...
class VolumeStructure(Structure.Structure[MutableSequence[MutableMapping[str,Any]]]):
    ...
    def compare(
        ...
        for coordinate1, block_data1 in additional_data1.items():
            ...
            if block_data2 is None:
                ...
                exceptions.extend(exception.add(self.name, coordinate1) for exception in new_exceptions)
            else:
    ...
    def print_text(
        ...
        for layer in range(size[1]):
            ...
            exceptions.extend(exception.add(self.name, layer) for exception in new_exceptions)
        return output, exceptions
