...
def main() -> None:
    ...
    files = [path for version in versions_selected if version.version_folder is not None and (path := version.version_folder.joinpath("data", dataminer_selected)).exists()]
