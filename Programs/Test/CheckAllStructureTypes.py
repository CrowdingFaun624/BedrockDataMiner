...
def check_types(version:Version.Version, dataminers:list[AbstractDataminerCollection.AbstractDataminerCollection], domain:"Domain.Domain") -> None:
    environment = StructureEnvironment.PrinterEnvironment(StructureEnvironment.StructureEnvironment(StructureEnvironment.EnvironmentType.checking_all_types, domain), None, version, 0)
